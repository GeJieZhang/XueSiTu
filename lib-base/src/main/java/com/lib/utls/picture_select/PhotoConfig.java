...
public class PhotoConfig {
    ...
    public static void selectPicture(Activity activity, List<LocalMedia> selectMedia, int selectNum) {
    ...
    public static void takePicture(Activity activity, List<LocalMedia> selectMedia, int selectNum) {
