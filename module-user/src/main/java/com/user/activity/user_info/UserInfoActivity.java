...
import com.lib.fastkit.views.file_size.PcUtils;
import com.lib.fastkit.db.sample_cache.ACache;
import com.lib.fastkit.utils.string_deal.empty.EmptyUtil;
    ...
    public void onViewClicked(View view) {
        ...
        if (i == R.id.lin_tx) {
            ...
            if (!EmptyUtil.isEmpty(userInfoBean.getModel().getIdCard())) {
                ...
                ARouter.getInstance().build(ARouterPathUtils.User_RealNameActivity).navigation();
            }
        }
    }
