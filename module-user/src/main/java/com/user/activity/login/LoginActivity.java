...
import com.lib.fastkit.http.rt.RetrofitManager;
import com.lib.fastkit.ioc.ViewUtils;
import com.lib.framework.component.interceptor.GroupUtils;
import com.lib.ui.activity.BaseAppActivity;
import com.lib.utls.permissions.PermissionUtil;
...
@Route(path = ARouterPathUtils.User_LoginActivity,group = GroupUtils.NEED_LOGIN)
...
//                        toLogin();
                        ...
                        ARouter.getInstance().build(ARouterPathUtils.User_TestActivity).navigation();
                    }
    ...
    public void onViewClicked(View view) {
        ...
        if (id == R.id.tv_forget) {
            ARouter.getInstance().build(ARouterPathUtils.User_FindPasswordActivity).navigation();
        }
