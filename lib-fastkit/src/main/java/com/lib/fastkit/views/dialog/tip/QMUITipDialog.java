...
package com.lib.fastkit.views.dialog.tip;
...
import com.lib.fastkit.views.dialog.tip.util.QMUILoadingView;
    ...
    public static class Builder {
        ...
        public QMUITipDialog create(boolean cancelable) {
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                tipView.setTextColor(ContextCompat.getColor(mContext, R.color.kit_white));
